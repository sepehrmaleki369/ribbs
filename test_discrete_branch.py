# Test Discrete Branch
# Verify the discrete-distance-maps branch is using discrete values
...
def test_discrete_branch():
    """Test the discrete branch to verify it's using discrete values"""
    
    print("=== TESTING DISCRETE BRANCH ===")
    ...
    print(f"Distance map directory: drive/training/discrete_distance_maps")
    print(f"File naming pattern: *_manual1_discrete_distance_map.npy")
    
    # Create visualization
    create_discrete_visualization(sample)
    
    print(f"\n✅ Discrete branch test completed!")
...
def create_discrete_visualization(sample):
    ...
    plt.tight_layout()
    plt.savefig('predictions/discrete_branch_test.png', dpi=300, bbox_inches='tight')
    print(f"Discrete branch test visualization saved as predictions/discrete_branch_test.png")

if __name__ == "__main__":
    test_discrete_branch() 